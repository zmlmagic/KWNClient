...
- (void)setupMessageInputViewBarWithStyle:(XHMessageInputViewStyle)style {
    ...
    if (self.allowsSendVoice) {
        button = [self createButtonWithImage:[UIImage imageNamed:@"voice"] HLImage:[UIImage imageNamed:nil]];
    ...
    if (self.allowsSendVoice) {
        ...
        button = [self createButtonWithImage:XH_STRETCH_IMAGE([UIImage imageNamed:@"VoiceBtn_Black"], edgeInsets) HLImage:XH_STRETCH_IMAGE([UIImage imageNamed:nil], edgeInsets)];
