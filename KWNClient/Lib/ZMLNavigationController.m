//
//  ZMLNavigationController.m
//  KWNClient
//
//  Created by 张明磊 on 14-4-30.
//  Copyright (c) 2014年 张明磊. All rights reserved.
//

#import "ZMLNavigationController.h"

@interface ZMLNavigationController ()<UIGestureRecognizerDelegate>
{
    CGPoint startPoint;
...
@implementation ZMLNavigationController
...
- (void)viewDidAppear:(BOOL)animated
{
    if(_view_titleRoot)
    {
        [self.view addSubview:_view_titleRoot];
    }
}
...
- (void) popAnimation {
    ...
    lastScreenShotView.frame = (CGRect){-([UIScreen mainScreen].bounds.size.width*offset_float),0,320,[UIScreen mainScreen].bounds.size.height};
...
- (void)moveViewWithX:(float)x
{
    ...
    self.view.frame = frame;
    // TODO
    lastScreenShotView.frame = (CGRect){-([UIScreen mainScreen].bounds.size.width*offset_float)+x*offset_float,0,320,[UIScreen mainScreen].bounds.size.height};
}
